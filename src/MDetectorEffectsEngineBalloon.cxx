...
bool MDetectorEffectsEngineBalloon::Initialize()
{
  ...
  m_ShieldVetoWindowSize = 0.4e-6; // Shield veto window size, unchanged from balloon.
...
double MDetectorEffectsEngineBalloon::dTimeShields(int detectors_activated){
...
// double MDetectorEffectsEngineBalloon::dTimeGeDs(vector<int> channels) {
