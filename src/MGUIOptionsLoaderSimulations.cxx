...
void MGUIOptionsLoaderSimulations::Create()
{
  ...
  m_SimulationFileSelector = new MGUIEFileSelector(m_OptionsFrame, "Please select a simulations file:",
    dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->GetSimulationFileName());
  ...
  m_EnergyCalibrationFileSelector = new MGUIEFileSelector(m_OptionsFrame, "Please select an energy calibration file:",
    dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->GetEnergyCalibrationFileName());
  ...
  m_DeadStripFileSelector = new MGUIEFileSelector(m_OptionsFrame, "Please select a dead strip file:",
    dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->GetDeadStripFileName());
  ...
  m_ThresholdFileSelector = new MGUIEFileSelector(m_OptionsFrame, "Please select a thresholds file:",
    dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->GetThresholdFileName());
  ...
  m_OptionsFrame->AddFrame(m_ThresholdFileSelector, LabelLayout);
	...
	m_GuardRingThresholdFileSelector = new MGUIEFileSelector(m_OptionsFrame, "Please select a guard ring thresholds file:",
		dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->GetGuardRingThresholdFileName());
	...
	m_ChargeSharingFileSelector = new MGUIEFileSelector(m_OptionsFrame, "Please select a charge sharing factor file:",
		dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->GetChargeSharingFileName());
	...
	m_CrosstalkFileSelector = new MGUIEFileSelector(m_OptionsFrame, "Please select a crosstalk coefficients file:",
		dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->GetCrosstalkFileName());
	...
	m_ChargeLossFileSelector = new MGUIEFileSelector(m_OptionsFrame, "Please select a charge loss coefficients file:",
		dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->GetChargeLossFileName());
  ...
  m_DepthCalibrationCoeffsFileSelector = new MGUIEFileSelector(m_OptionsFrame, "Please select a depth calibration coefficients file:",
    dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->GetDepthCalibrationCoeffsFileName());
  ...
  m_DepthCalibrationSplinesFileSelector = new MGUIEFileSelector(m_OptionsFrame, "Please select a depth calibration splines file:",
    dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->GetDepthCalibrationSplinesFileName());
  ...
  m_ApplyFudgeFactorSelector->SetOn(dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->GetApplyFudgeFactor());
  ...
  m_StopAfter->SetOn(dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->UseStopAfter());
  ...
  m_MaximumAcceptedEvents = new MGUIEEntry(PassedFrame, " ", false, 
                                           dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->GetMaximumAcceptedEvents(), true, 0l);
...
bool MGUIOptionsLoaderSimulations::OnApply()
{
  ...
  dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->SetSimulationFileName(m_SimulationFileSelector->GetFileName());
  dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->SetEnergyCalibrationFileName(m_EnergyCalibrationFileSelector->GetFileName());
  dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->SetThresholdFileName(m_ThresholdFileSelector->GetFileName());
	dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->SetGuardRingThresholdFileName(m_GuardRingThresholdFileSelector->GetFileName());
	dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->SetChargeSharingFileName(m_ChargeSharingFileSelector->GetFileName());
	dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->SetCrosstalkFileName(m_CrosstalkFileSelector->GetFileName());
	dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->SetChargeLossFileName(m_ChargeLossFileSelector->GetFileName());
  dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->SetDeadStripFileName(m_DeadStripFileSelector->GetFileName());
  dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->SetDepthCalibrationCoeffsFileName(m_DepthCalibrationCoeffsFileSelector->GetFileName());
  dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->SetDepthCalibrationSplinesFileName(m_DepthCalibrationSplinesFileSelector->GetFileName());
  dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->SetApplyFudgeFactor(m_ApplyFudgeFactorSelector->IsOn());
  dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->SetUseStopAfter(m_StopAfter->IsOn());
  dynamic_cast<MModuleLoaderSimulationsSMEX*>(m_Module)->SetMaximumAcceptedEvents(m_MaximumAcceptedEvents->GetAsInt());
